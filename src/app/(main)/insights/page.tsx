  ...
  return (
    <div className="flex flex-col gap-4">
        <div className="flex items-center justify-between">
            <div>
                <h1 className="font-headline text-2xl font-bold">Business Insights</h1>
                <p className="text-muted-foreground">AI-powered suggestions to help you grow your business.</p>
            </div>
